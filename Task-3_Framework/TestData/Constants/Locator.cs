...
namespace App.TestData.Constants
{
    public struct Locator {
        ...
        //public const string TabTopSeller = "//div[@id='tab_select_TopSellers']";
        ...
        public const string TopSallersRowsItem = "..//a[starts-with(@class,'tab_item')]";//"//a[contains(@class,'tab_item')]";//"//a[@class='tab_item app_impression_tracked']";
        public const string OriginalPrice = "./div[contains(@class,'discount_block')]/div[@class='discount_prices']/div[@class='discount_original_price']";//"..//descendant::div[@class='discount_original_price']";//"//div[@class='discount_original_price']";
        public const string FinalPrice = "./div[contains(@class,'discount_block')]/div[@class='discount_prices']/div[@class='discount_final_price']";//"//div[@class='discount_final_price']";
        public const string Discount = "./div[contains(@class,'discount_block')]/div[@class='discount_pct']";//..//descendant::div[@class='discount_pct']";//"//div[@class='discount_pct']";
